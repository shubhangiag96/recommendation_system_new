...
class homepage(CreateView):
    ...
    def get(self,request):
        ...
        form1 = ContactForm()
        hotels = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\final_hotels1.csv')
        ratings = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\hotel_review.csv')
        ...
        ratings_mean.to_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\rating_mean.csv')
        ...
        ratings_total.to_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\ratings_total.csv')
        ratings_total = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\ratings_total.csv')
        ratings_mean = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\rating_mean.csv')
        ...
        '''
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\pop_hotel.json',
                  mode='w',encoding='utf-8') as f:
            json.dump(qfinal_res, f, sort_keys=True, indent=4, separators=(',', ': '))

        '''
        restr = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\final_rest.csv')
        ratings = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\rest_review.csv')
        ratings.drop(['review_id'], axis=1, inplace=True)
        ...
        ratings_mean = (dataset.groupby(['business_id', 'name']))['business_id', 'stars', 'name'].mean()
        ratings_mean.to_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\rating_mean1.csv')
        # modify the dataframes so that we can merge the two
        # print(ratings_mean.head())

        ratings_total = pd.DataFrame({'business_id': ratings_total.index, 'total_ratings': ratings_total.values})
        ratings_total.to_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\ratings_total1.csv')
        ratings_total = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\ratings_total1.csv')
        ratings_mean = pd.read_csv('E:\\projectStart\\mysite\\webapp\\static\\datasets\\rating_mean1.csv')
        # final merge
        ...
        '''
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\pop_rest.json',
                  mode='w',encoding='utf-8') as f:
            json.dump(qfinal_res1, f, sort_keys=True, indent=4, separators=(',', ': '))
        '''
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\pop_rest.json', encoding='utf-8') as f:
            pr=json.load(f)
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\pop_hotel.json', encoding='utf-8') as f:
            ph=json.load(f)
...
def dashboard(request):
    ...
    with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\rest_user_rating.json', encoding='utf-8') as f:
        rFile = json.load(f)
    rfile = [x for x in rFile if x['user_id'] == user]
    with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\hotel_user_rating.json', encoding='utf-8') as f:
        hFile = json.load(f)
...
def hoteldisplay(request):
    ...
    if request.method == 'POST' and 'b5' in request.POST:
        ...
        if form.is_valid():
            ...
            with open('E:\\projectStart\\mysite\\webapp\\static\\datasets\\final_hotels1.json',
                      encoding='utf-8') as j_file:
             tFile = json.load(j_file)
...
def restdisplay(request):
    ...
    if request.method == 'POST' and 'b3' in request.POST:
        ...
        if form.is_valid():
            pid = form.cleaned_data['name']
            imgsrc = form.cleaned_data['name1']
            with open('E:\\projectStart\\mysite\\webapp\\static\\datasets\\final_rest.json',
                      encoding='utf-8') as j_file:
             tFile = json.load(j_file)
...
def ratingsubmit(request):
    ...
    if request.method == 'POST' and 'b7' in request.POST:
        ...
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\place_user_rating.json',mode='w', encoding='utf-8') as f:
    ...
    if request.method == 'POST' and 'b8' in request.POST:
        ...
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\hotel_user_rating.json',mode='w', encoding='utf-8') as f:
    ...
    if request.method == 'POST' and 'b9' in request.POST:
        ...
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\rest_user_rating.json',encoding='utf-8') as f:
            rFile = json.load(f)
        rFile.insert(0,ratedict)
        with open('E:\\projectStart\\mysite\\webapp\\static\\personal\\rest_user_rating.json',mode='w', encoding='utf-8') as f:
            json.dump(rFile, f, sort_keys=True, indent=4, separators=(',', ': '))
