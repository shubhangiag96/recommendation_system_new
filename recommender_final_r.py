...
class RecommenderFinal():
    ...
    def calculate_baseline_estimates(self):
        ...
        with open('E:\\projectStart\\mysite\\pickelFiles\\rating_average.pickle', 'wb') as f3:
    ...
    def train(self):
        ...
        with open('E:\\projectStart\\mysite\\pickelFiles\\user_factors.pickle', 'wb') as f4:
            pickle.dump(self.user_factors, f4)
        with open('E:\\projectStart\\mysite\\pickelFiles\\item_factors.pickle', 'wb') as f5:
    ...
    def recommend(self, user_id, num_items):
        ...
        with open('E:\\projectStart\\mysite\\dataset\\r_userMapping.json') as user_mapping_file:
            self.users = json.load(user_mapping_file)
        with open('E:\\projectStart\\mysite\\dataset\\r_itemMapping.json') as item_mapping_file:
            self.items=json.load(item_mapping_file)
        #LOADING PICKLE FILES
        with open('E:\\projectStart\\mysite\\pickelFiles\\user_bias.pickle', 'rb') as f1:
            self.user_biases=pickle.load(f1)
        with open('E:\\projectStart\\mysite\\pickelFiles\\item_bias.pickle', 'rb') as f2:
            self.item_biases=pickle.load(f2)
        with np.load('E:\\projectStart\\mysite\\dataset\\Rest_ratingMatrix.npz') as sparse_matrix:
            self.ratings = sps.coo_matrix((sparse_matrix['data'], (sparse_matrix['row'], sparse_matrix['col'])),
                                          shape=sparse_matrix['shape'])
        with open('E:\\projectStart\\mysite\\pickelFiles\\rating_average.pickle', 'rb') as f3:
            self.rating_avg=pickle.load(f3)
        with open('E:\\projectStart\\mysite\\pickelFiles\\user_factors.pickle', 'rb') as f4:
            self.user_factors=pickle.load(f4)
        with open('E:\\projectStart\\mysite\\pickelFiles\\item_factors.pickle', 'rb') as f5:
